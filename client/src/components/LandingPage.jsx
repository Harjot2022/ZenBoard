...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      <Helmet>
        <title>ZenBoard - Real-Time Kanban Project Management</title>
        <meta
          name="description"
          content="A real-time Kanban project management tool with multi-tenant architecture to support seamless team collaboration."
        />
        <meta
          property="og:title"
          content="ZenBoard - Real-Time Kanban Project Management"
        />
        <meta
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 text-center lg:text-left z-10">
            ...
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Simplify project management with our intuitive Kanban boards.
              Collaborate with your team, track progress, and hit your deadlines
              effortlessly.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                to="/login"
                className="flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-3.5 rounded-full text-lg font-semibold hover:bg-blue-700 transition shadow-xl shadow-blue-600/20"
              >
          ...
          <div className="lg:w-1/2 w-full relative">
            ...
            <div className="relative bg-gray-100 p-4 rounded-xl shadow-2xl border border-gray-200 transform rotate-1 hover:rotate-0 transition duration-500">
              ...
              <div className="flex items-center gap-2 mb-4 px-2">
                ...
                <div className="bg-white flex-1 mx-4 h-6 rounded-md text-[10px] flex items-center px-2 text-gray-400">
                  ZenBoard.app/board/marketing-launch
                </div>
              </div>
              ...
              <div className="flex gap-4 overflow-hidden h-80">
                ...
                <div className="w-1/3 bg-gray-200/50 rounded-lg p-3 flex flex-col gap-3 opacity-80">
                  ...
                  <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 opacity-60">
                    <div className="text-xs font-medium text-gray-800 line-through text-gray-400">
                      Setup Project Repo
                    </div>
                  </div>
                  <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100 opacity-60">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              ZenBoard gives you the power of a complex project management tool
              with the simplicity of a whiteboard.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 leading-relaxed">
                Visualise your workflow with our intuitive drag-and-drop
                interface. Moving tasks feels natural and fluid.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 leading-relaxed">
                Invite your team, assign tasks, and leave comments in real-time.
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 leading-relaxed">
                Changes happen instantly. No refreshing required. See tasks move
                as your team completes them.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 text-center relative">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Sign up and create your first project board in seconds.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-500">
                Break down your project into manageable cards and lists.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-500">
                Drag cards to "Done" and celebrate your team's wins.
              </p>
            </div>
          </div>
        </div>
